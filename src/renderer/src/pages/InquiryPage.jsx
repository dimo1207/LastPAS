function InquiryPage({ onNavigateMenu, selectedSession }) {
    return (
        <div className="menu-screen">
            <div className="menu-screen__header" />

            <div className="menu-screen__title">Inquiry</div>

            <div className="menu-screen__panel">
                <div className="menu-screen__empty">
                    {selectedSession
                        ? `Inquiry page placeholder for ${selectedSession.participantLabel ?? 'selected record'}.`
                        : 'No record selected.'}
                </div>
