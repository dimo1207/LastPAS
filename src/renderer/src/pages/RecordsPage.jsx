function RecordsPage({ onNavigateMenu, selectedSession }) {
    return (
        <div className="menu-screen">
            <div className="menu-screen__header" />

            <div className="menu-screen__title">Records</div>

            <div className="menu-screen__panel">
                <div className="menu-screen__empty">
                    {selectedSession
                        ? `Records page placeholder for ${selectedSession.participantLabel ?? 'selected record'}.`
                        : 'No record selected.'}
                </div>
